...
public class MainActivity extends ListActivity {
    ...
    String[] countries = {"Аргентина", "Бразилия", "Чили", "Колумбия", "Уругвай", "Крутая кошка"};
    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent intent3 = new Intent(MainActivity.this, Chilie.class);
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        Intent intent6 = new Intent(MainActivity.this, Koshka_krutaya.class);
